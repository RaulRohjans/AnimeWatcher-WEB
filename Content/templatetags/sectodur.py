...
def sectodur(value, arg=''):
    ...
    if secs > 0:
        ...
        if hours > 0 and arg == 'long':
            # Add multiple days to duration string
            durationString += hourSplitter + ' ' + str(hours) + hourUnitName + (hours > 1 and 's' or '')
        elif hours > 0:
            # Add multiple days to duration string
            durationString += hourSplitter + '' + str(hours) + hourUnitName + (hours > 1 and '' or '')
        ...
        if minutes > 0 and arg == 'long':
            ...
            if minutes > 10:
                ...
                # Add multiple days to duration string
                durationString += minSplitter + '' + '0' + str(minutes) + minUnitName + (minutes > 1 and '' or '')
        elif minutes == 0:
            durationString += minSplitter + '' + str(minutes) + '0' + minUnitName + (minutes > 1 and '' or '')
        ...
        if seconds > 0 and arg == 'long':
            ...
            if seconds > 10:
                ...
                # Add multiple days to duration string
                durationString += secSplitter + '' + '0' + str(seconds) + secUnitName + (seconds > 1 and '' or '')
        elif seconds == 0:
            durationString += secSplitter + '' + str(seconds) + secUnitName + (seconds > 1 and '' or '') + '0'
